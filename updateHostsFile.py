...
def write_opening_header(final_file, **header_params):
    ...
    write_data(final_file, "# http://ador.heliohost.com/\n# Energized Malware Protection\n# Version: 2.0\n")
    ...
    write_data(final_file, "# Host Source: http://ador.heliohost.org/EnergizedMalware\n# Raw Host: "
                           "https://raw.githubusercontent.com/AdroitAdorKhan/Energized/master/EnergizedMalware\n")
    write_data(final_file, "# Project Web: http://ador.heliohost.org/\n")
    write_data(final_file, "# Project Git: https://github.com/AdroitAdorKhan/Energized\n#\n")
    write_data(final_file, "# -=============================================================-\n# Maintainer: Nayem Ador - https://adroitadorkhan.github.io\n# ===============================================================\n")
    write_data(final_file, "\n")
